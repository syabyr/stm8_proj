...
{
  /* Initialize I/Os in Output Mode for LED */
  ...
  //fan pwm
  GPIO_Init(FAN_PORT, (GPIO_Pin_TypeDef)(FAN_PWM_PIN),GPIO_MODE_OUT_PP_HIGH_FAST);
}
...
void main(void)
{
  ...
  FAN_PORT->ODR|=FAN_SW_PIN;
  FAN_PORT->ODR|=FAN_PWM_PIN;
