...
;	CMakeCCompilerId.c:754: const char* info_language_dialect_default =
...
;------------------------------------------------------------
;	CMakeCCompilerId.c:765: int main(int argc, char* argv[])
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	mov	r6,dpl
	mov	r7,dph
;	CMakeCCompilerId.c:769: require += info_compiler[argc];
	mov	a,r6
	...
	mov	r3,a
	mov	r5,#0x00
;	CMakeCCompilerId.c:770: require += info_platform[argc];
	mov	a,r6
	...
	addc	a,r5
	mov	r4,a
;	CMakeCCompilerId.c:771: require += info_arch[argc];
	mov	a,r6
	add	a,_info_arch
	mov	r2,a
	mov	a,r7
	...
	addc	a,r4
	mov	r5,a
;	CMakeCCompilerId.c:773: require += info_version[argc];
	mov	a,r6
	add	a,#_info_version
	mov	dpl,a
	mov	a,r7
	...
	addc	a,r5
	mov	r5,a
;	CMakeCCompilerId.c:787: require += info_language_dialect_default[argc];
	mov	a,r6
	...
	addc	a,r5
	mov	dph,a
;	CMakeCCompilerId.c:789: return require;
;	CMakeCCompilerId.c:790: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
_info_version:
