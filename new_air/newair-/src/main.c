...
extern int16_t nCounter;
extern int16_t speed_counter;
/**
  * @brief  Main program.
  * @param  None
  * @retval None
...
void main(void)
{
  ...
  while (1)
  {
      if ((GPIO_ReadInputData(FAN_SENSE_PORT) & FAN_SENSE_PIN) == 0x00)
      {
...
static void GPIO_Config(void)
{
  ...
  /* Initialize I/O in Input Mode for FAN Sense */
  GPIO_Init(FAN_SENSE_PORT,(GPIO_Pin_TypeDef)(FAN_SENSE_PIN),GPIO_MODE_IN_FL_NO_IT);
