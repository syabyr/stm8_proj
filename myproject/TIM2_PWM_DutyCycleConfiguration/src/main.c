...
void main(void)
{
  ...
  TIM2_Config();  
/*
  GPIOD->DDR=GPIO_PIN_2|GPIO_PIN_3;
  GPIOD->CR1=GPIO_PIN_2|GPIO_PIN_3;
  GPIOD->CR2=GPIO_PIN_2|GPIO_PIN_3;
  while(1)
  {
      GPIOD->ODR&=~(GPIO_PIN_2|GPIO_PIN_3);
      ;
      ;
      ;
      ;
...
static void TIM2_Config(void)
{
  ...
  TIM2_TimeBaseInit(TIM2_PRESCALER_1, 51);
