...
bool keysw_pressed = FALSE;
int keysw_presscount=0;
...
void key_scan(void)
{
	if(MY_GPIO_ReadInputPin(GPIOB, GPIO_PIN_7) == RESET)     //KEYALL
	{
		//PB7常为高电平
		//KEYALL PRESSED
		if(keysw_pressed == FALSE)
		{
			keysw_pressed = TRUE;
		}
		keysw_pressed = TRUE;
		keysw_presscount++;
		if(2 == keysw_presscount)
		{
			warn_on();
		}
		if(60 == keysw_presscount)
		{
			warn_off();
			self_poweroff();
		}
...
void start_ht1621()
{
	GPIOD->ODR|=GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6;
	Delay(1);
	GPIOD->ODR&=~(GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6);
}
...
int8_t num1[]={num10,num11,num12,num13,num14,num15,num16,num17,num18,num19,0};
int8_t num2[]={num20,num21,num22,num23,num24,num25,num26,num27,num28,num29,0};
int8_t num3[]={num30,num31,num32,num33,num34,num35,num36,num37,num38,num39,0};
